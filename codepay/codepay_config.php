...
define('DB_USER', 'syb');  //数据库用户名
define('DB_PWD', 'KjCX463aScxzCkTS');//数据库密码
define('DB_NAME', 'syb');  //数据库名称
...
define('DB_USERMONEY', 'money2');  //充值用户所在表中的金额字段名
